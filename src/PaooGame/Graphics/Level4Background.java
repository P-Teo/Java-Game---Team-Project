 ...
 * fundalul specific pentru nivelul 4 din joc.
 */

public class Level4Background extends LevelBackground{
    private BufferedImage image; // Imaginea de fundal pentru nivelul 4
    private int x = 0; // Coordonata X a fundalului – folosită pentru efectul de scroll

    ///Constructorul clasei. Încarcă imaginea de fundal pentru nivelul 4
    public Level4Background() {
        try { image = ImageIO.read(getClass().getResource("/Background/Backgroundlevel4.png"));
