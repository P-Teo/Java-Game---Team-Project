 ...
 * fundalul specific pentru nivelul 1 din joc.
 */

public class Level1Background extends LevelBackground{
    private BufferedImage image; // Imaginea de fundal pentru nivelul 1
    private int x = 0; // Coordonata X a fundalului – folosită pentru efectul de scroll

    ///Constructorul clasei. Încarcă imaginea de fundal pentru nivelul 1
    public Level1Background() {
        try { image = ImageIO.read(getClass().getResource("/Background/Backgroundlevel1.png"));
