...
/// Clasa pentru inamicul de nivel 2, moștenește clasa de bază Entity

public class Enemylvl2  extends Entity{
    ...
    private void loadSharedImages() {
        try {
            for (int i = 0; i < 12; i++) {
                sharedLeftRunning[i] = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_run_left_" + i + ".png"));
                sharedRightRunning[i] = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_run_right_" + i + ".png"));
                sharedLeftAttack[i] = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_attack_left_" + i + ".png"));
                sharedRightAttack[i] = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_attack_right_" + i + ".png"));
            }
            for (int i = 0; i < 15; i++) {
                sharedLeftDie[i] = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_die_left_" + i + ".png"));
                sharedRightDie[i] = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_die_right_" + i + ".png"));
            }
            sharedIdleRight = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_idle_right.png"));
            sharedIdleLeft = ImageIO.read(getClass().getResource("/Characters/Enemy2/Enemy2_idle_left.png"));
            imagesLoaded = true;
    ...
    public void draw(Graphics g) {
        ...
        double healthPercent = (double) health / 10;
