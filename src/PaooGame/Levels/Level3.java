...
/// extinde clasa Level pentru a face nivelul 3
...
public class Level3 extends Level {
    ...
    int maxEnemies = 12;
    int maxNowEnemies;
    List<Enemylvl3> enemies = new ArrayList<>(); // lista inamicilor activi din nivel
    ...
    public Level3(Game game,GameWindow wnd) {
        ...
        player = new Player();
        score=0;  star=0;
        background = LevelBackgroundFactory.createLevelBackground(3);
        showMessage = true;
        levelCompleted = false;
        gameOver = false;
        startTime = System.currentTimeMillis();
        castle1 = new Castle1(20,200,225,150, "/BackgroundCastle/Castle5.png");
        castle2 = new Castle1(background.getWidth()-200,150,300,100,"/BackgroundCastle/Castle6.png");
    ...
    public void draw(Graphics g) {
        ...
        for (Enemylvl3 enemy : enemies) { if(!showMessage){ enemy.draw(g); } }// Desenează inamicii
        if (levelCompleted) { game.nrLevel=4; drawLevelCompleteMessage(g); }// Afișează mesajul de felicitări
    ...
    public void mouseClicked(int x, int y) {
        ...
        if (isPaused && isMouseClickedInButton(x, y, resumeButtonBounds.x, resumeButtonBounds.y, resumeButtonBounds.width, resumeButtonBounds.height)) { isPaused = false; /* Reluăm jocul*/}
